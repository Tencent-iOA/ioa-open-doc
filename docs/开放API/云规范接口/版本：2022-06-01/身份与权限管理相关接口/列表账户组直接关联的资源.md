...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Data | [DescribeAccountResourcesData](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#DescribeAccountResourcesData) | 查询的数据集合<br/>注意：此字段可能返回 null，表示取不到有效值。|
