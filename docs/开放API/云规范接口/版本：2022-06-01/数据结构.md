...
| Uid | Integer | 用户id(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Source | Integer | 来源(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| IdPath | String | id路径<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Ip | String | ip地址<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| HostName | String | 主机名<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| UserId | String | 绑定用户id<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Id | Integer | 绑定id(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Access | Integer | 权限(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| GroupName | String | 分组名<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| State | Integer | 状态(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Itime | String | 插入时间<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| DeviceType | String | 设备类型<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| DeviceId | String | 设备id<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Os | String | 操作系统<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| GroupId | Integer | 分组id(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
被如下接口引用：DescribeAccountGroups, DescribeBusinessResources, DescribeDevices, DescribeLocalAccounts, DescribeResourceModules。
...
| PageNum | Integer | PageNum 获取第几页，0值和负数不分页，返回全部数据(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| PageSize | Integer | PageSize 每页获取数，Max=5000，超过Max按Max处理, Min=10 ，小于等于0时按Min处理(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| 名称 | 类型 |  描述 |
|------|------|-------|
| Items | Array of [DeviceDetail](#DeviceDetail) | 业务响应数据<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Paging | [Paging](#Paging) | 数据分页信息<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| IdentityStrategyVer | String | 身份策略版本<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Monitor | String | 显示器品牌型号<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| HardwareChangeCount | Integer | 硬件变更记录数量<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| AccountUsers | String | 绑定账户只有名字<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| IdentityNewStrategyVer | String | 身份策略新版本<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| BaseBoardManufacturer | String | 主板制造商<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| NoPermission | Integer | 绑定账户所有数据(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| DomainName | String | 域名<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| Driver | Integer | 驱动防护状态(只支持32位)<br/>注意：此字段可能返回 null，表示取不到有效值。 |
| BaseBoardSn | String | 主板序列号<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| SystemArchitecture | String | 系统架构<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| AccountList | Array of [AccountBindDevice](#AccountBindDevice) | 绑定账户所有数据<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| MemoryDetail | String | 内存详情<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
| IsCustom | String | 必填数据<br/>注意：此字段可能返回 null，表示取不到有效值。 |
...
被如下接口引用：CheckBusinessResource, DescribeAccountGroups, DescribeBusinessResources, DescribeDevices, DescribeLocalAccounts, DescribeResourceModules。
