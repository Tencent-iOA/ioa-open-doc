...
| Condition | 否 | [Condition](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#Condition) | 滤条件、分页参数<br/><li>DeviceType - String - 是否必填：否 - 操作符: eq, like, ilike  - 排序支持：否- 按设备类型查询。</li> |
