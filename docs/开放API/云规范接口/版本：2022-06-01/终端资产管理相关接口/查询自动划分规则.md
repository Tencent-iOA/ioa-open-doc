...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/product/1679/14881?!preview&preview_docmenu=1&lang=cn&!document=1)，本接口取值：DescribeAutoVirtualGroupRule。 |
...
| VirtualGroupId | 否 | Integer | 自定义分组id |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Data | [DescribeAutoVirtualGroupRuleRspData](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#DescribeAutoVirtualGroupRuleRspData) | 响应数据<br/>注意：此字段可能返回 null，表示取不到有效值。|
