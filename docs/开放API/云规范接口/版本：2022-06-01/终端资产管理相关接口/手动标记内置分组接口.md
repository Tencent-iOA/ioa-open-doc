...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/product/1679/14881?!preview&preview_docmenu=1&lang=cn&!document=1)，本接口取值：MarkInsideGroupManually。 |
...
| DeviceIds.N | 否 | Array of Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>做标记的设备列表 |
| TagValue | 否 | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>标记的值 (101：所有权-公司资产、102：所有权-私人资产、103：所有权-未分类资产, 201：接入状态-已接入、202：接入状态-未接入, 301：实时防护-已开启、302：实时防护-未开启) |
