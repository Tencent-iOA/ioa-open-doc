...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/product/1679/14881?!preview&preview_docmenu=1&lang=cn&!document=1)，本接口取值：DeleteAutoVirtualGroupRule。 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Data | [AutoVirtualGroupRuleRspData](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#AutoVirtualGroupRuleRspData) | 响应数据<br/>注意：此字段可能返回 null，表示取不到有效值。|
