...
| Name | 是 | String | 网关名称 |
| SvrAddresses.N | 是 | Array of [IpPort](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#IpPort) | 网关地址列表 |
| ClientIps.N | 否 | Array of [ClientIp](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#ClientIp) | 客户端ip |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Data | [CreateZeroTrustGatewayData](/document/product/1679/76684?!preview&preview_docmenu=1&lang=cn&!document=1#CreateZeroTrustGatewayData) | 业务响应数据<br/>注意：此字段可能返回 null，表示取不到有效值。|
