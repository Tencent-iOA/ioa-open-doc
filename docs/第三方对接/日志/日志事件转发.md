...
注意：该上报原始格式为 csv ，上报内容在 `message` 字段中，需要解析后使用，内容列如下
...
```json
{
    "message":"\"2024-01-17T08:07:01.146Z\",\"www.baidu.com:443\",\"100\",\"127.0.0.1\",\"80\",\"IPv4\",\"127.0.0.1\",\"28880\",\"127.0.0.1:80\",\"127.0.0.1\",\"443\",\"Basic eyJJZCI6IjAXXX\",\"127.0.0.1\",\"Mozilla/5.0 (Windows NT 10.0; WOW64)\",\"tcp\",\"\",\"2769\",\"2284\",\"111\",\"off\""
}
```
