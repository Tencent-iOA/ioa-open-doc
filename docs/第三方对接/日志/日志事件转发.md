...
| 字段名 | 字段类型 | 字段说明 | 取值说明 |
| --- | --- | --- | --- |
| NoKBList | list-string | 不合规的KB列表 | : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> |
| ErrorCode | string | 扫描项检查失败的错误信息 | : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> : <br /> |
| Source | int | 来源 | 0: 未知<br /> 1: 界面触发<br /> 1: 定时器触发<br /> |
| Result | int | 合规检查结果 | 0: 未进行合规检查<br /> 1: 合规<br /> 2: 不合规<br /> 3: 检查失败<br /> |
| Risklevel | int | 风险等级 | |
